...
<br><strong>Procédure d'extraction des IF :</strong><br><br>

<form method="POST" accept-charset="utf-8" name="ajout" action="ExtrHAL_IF_import.php" enctype="multipart/form-data">
