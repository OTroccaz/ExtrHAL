...
if ($_FILES['importcomplet']['name'] != "") {
  ...
  if ($ext != ".csv" && $ext != ".txt"){
    header("location:"."ExtrHAL_liste_auteurs.php?erreur=extfic"); exit;
  }else{
    if ($_FILES['importcomplet']['size'] == "0") {
      header("location:"."ExtrHAL_liste_auteurs.php?erreur=nulfic"); exit;
    }else{
...
if (isset($_POST["cehval"]) && $_POST["cehval"] != "") {
  header("location:"."ExtrHAL_liste_auteurs.php?cehval=".$_POST["cehval"]); exit;
}else{
  header("location:"."ExtrHAL_liste_auteurs.php"); exit;
}
?>
