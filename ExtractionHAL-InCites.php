...
<br><strong>Procédure d'extraction des InCites :</strong><br><br>

<form method="POST" accept-charset="utf-8" name="ajout" action="ExtractionHAL-InCites-import.php" enctype="multipart/form-data">
Sélectionnez le fichier à importer :
<input type="file" name="import" size="30" style="font-family: Corbel, sans-serif; font-size: 10pt;"><br>
<br>
