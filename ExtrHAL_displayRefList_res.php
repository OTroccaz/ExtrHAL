...
if (isset($choix_ouvr) && strpos($choix_ouvr, "-EOS-") !== false) {
	echo "<br><a name=\"EOS\"></a><h2>Editions d’ouvrages scientifiques".$cpmlng.$detail." <a href=\"#sommaire\"><i class=\"mdi mdi-arrow-up-bold\"></i></a></h2>";
	//$Fnm1 = "./HAL/extractionHAL_".$team.".csv";
	$inF1 = fopen($Fnm1,"a+");
	//fseek($inF1, 0);
	fwrite($inF1,"Editions d’ouvrages scientifiques".$cpmlng.$detail.chr(13).chr(10));
	$inFH = fopen($FnmH,"a+");
	fwrite($inFH,"Editions d’ouvrages scientifiques".$cpmlng.$detail.chr(13).chr(10));
	$sect->writeText("<br><strong>Editions d’ouvrages scientifiques".$cpmlng.$detail."</strong><br>", $fonth2);
