...
if (isset($choix_autr) && strpos($choix_autr, "-IMG-") !== false) {
	echo "<br><a name=\"VIDEO\"></a><h2>Images".$cpmlng.$detail." <a href=\"#sommaire\"><i class=\"mdi mdi-arrow-up-bold\"></i></a></h2>";
	//$Fnm1 = "./HAL/extractionHAL_".$team.".csv";
	$inF1 = fopen($Fnm1,"a+");
	//fseek($inF1, 0);
...
if (isset($choix_autr) && strpos($choix_autr, "-BLO-") !== false) {
	echo "<br><a name=\"BLO\"></a><h2>Billets de blog".$cpmlng.$detail." <a href=\"#sommaire\"><i class=\"mdi mdi-arrow-up-bold\"></i></a></h2>";
	//$Fnm1 = "./HAL/extractionHAL_".$team.".csv";
	$inF1 = fopen($Fnm1,"a+");
	//fseek($inF1, 0);
...
if (isset($choix_autr) && strpos($choix_autr, "-NED-") !== false) {
	echo "<br><a name=\"NED\"></a><h2>Notices d'encyclopédie ou dictionnaire".$cpmlng.$detail." <a href=\"#sommaire\"><i class=\"mdi mdi-arrow-up-bold\"></i></a></h2>";
	//$Fnm1 = "./HAL/extractionHAL_".$team.".csv";
	$inF1 = fopen($Fnm1,"a+");
	//fseek($inF1, 0);
